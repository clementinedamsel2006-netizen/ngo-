...
st.markdown(
    ...
    <style>
        /* ============================================================
           LIGHT UI / MOBILE CONTRAST FIX
           ============================================================ */

        .stApp {
            background: linear-gradient(180deg, #f7faf8 0%, #eef3f1 100%) !important;
        ...
        [data-testid="stSidebar"] [role="radio"][aria-checked="true"] * {
            ...
            -webkit-text-fill-color: #f04f4f !important;
        }
        ...
        /* ------------------------------------------------------------
           BUTTONS
           The old dark-theme text color made button labels almost
           black/grey on dark buttons. Force high-contrast white text.
           ------------------------------------------------------------ */
        .stButton > button,
        .stButton > button *,
        button[kind="primary"],
        ...
        /* Keep disabled buttons readable rather than dark-grey text. */
        ...
        /* Dividers must remain visible on the light theme. */
        hr {
