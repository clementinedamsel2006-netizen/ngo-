...
# Keep the CSV files in a "data" folder next to this Python file.
# This makes the project portable: it works from C:, D:, another drive,
# another Windows computer, macOS, Linux, or when the project is copied
# to a different folder.
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DATA = os.path.join(BASE_DIR, "data")

# Create the data folder automatically if it does not exist yet.
